...
<body>
    <br /><br /><span style="color:springgreen;background:gray;font-size:30px;font-weight:bold;border-radius:15px;padding:5px;"><a href="Default.aspx" style="text-decoration:none;"><<</a></span>
    <form id="form1" runat="server">
    <div id="d1">
        <div id="header">
            <div id="logo"><img src="images/gglLogo.gif" height="130px" width="130px" /></div>
        ...
        <table id="tb1">
            ...
            <tr>
                <td colspan="3"><asp:ImageButton ID="btnlogin" runat="server" ImageUrl="~/images/download (11).jpg" Height="50px" Width="153px" OnClick="btnlogin_Click"/>&nbsp;
                    <br />
                    <span class="auto-style3" style="color: #008080"><a href="forgotpassword.aspx">Forget password</a></span></td>
